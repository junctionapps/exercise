# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-11 01:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(blank=True, help_text='FA or Glyph class for an icon. eg: "fa fa-th-large"', max_length=256)),
                ('access_permissions', models.ManyToManyField(blank=True, to='auth.Permission', verbose_name='Permissions granting access')),
                ('parent', models.ForeignKey(blank=True, help_text='Parent site tree item.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customtreeitem_parent', to='appscommon.CustomTreeItem', verbose_name='Parent')),
                ('tree', models.ForeignKey(help_text='Site tree this item belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='customtreeitem_tree', to='sitetree.Tree', verbose_name='Site Tree')),
            ],
            options={
